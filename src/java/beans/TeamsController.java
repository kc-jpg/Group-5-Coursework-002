...
public class TeamsController implements Serializable {
    ...
    private TeamsJpaController jpaController = null;
    ...
    private TeamsJpaController getJpaController() {
        if (jpaController == null) {
            jpaController = new TeamsJpaController(utx, emf);
        }
        ...
        if (pagination == null) {
            pagination = new PaginationHelper(10) {
                ...
                public int getItemsCount() {
                    return getJpaController().getTeamsCount();
                }

                @Override
                public DataModel createPageDataModel() {
                    return new ListDataModel(getJpaController().findTeamsEntities(getPageSize(), getPageFirstItem()));
                }
            };
        }
        return pagination;
    ...
    private void performDestroy() {
        try {
            getJpaController().destroy(current.getTeamId());
    ...
    private void updateCurrentItem() {
        int count = getJpaController().getTeamsCount();
        ...
        if (selectedItemIndex >= 0) {
            current = getJpaController().findTeamsEntities(1, selectedItemIndex).get(0);
        }
    }
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItems(getJpaController().findTeamsEntities(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItems(getJpaController().findTeamsEntities(), true);
    }
    ...
    public static class TeamsControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getJpaController().findTeams(getKey(value));
        }
